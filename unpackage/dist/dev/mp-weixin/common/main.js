...
/***/ 0:
/*!***********************************************!*\
  !*** /Users/lisicheng/project/lijian/main.js ***!
  \***********************************************/
...
var _uviewUi = _interopRequireDefault(__webpack_require__(/*! @/components/uview-ui */ 62));
var _app = _interopRequireDefault(__webpack_require__(/*! @/mixins/app */ 88));
...
var MescrollBody = function MescrollBody() {
  Promise.all(/*! require.ensure | components/mescroll-uni/mescroll-body */[__webpack_require__.e("common/vendor"), __webpack_require__.e("components/mescroll-uni/mescroll-body")]).then((function () {
    return resolve(__webpack_require__(/*! @/components/mescroll-uni/mescroll-body.vue */ 881));
  }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
};
var routerLink = function routerLink() {
  __webpack_require__.e(/*! require.ensure | js_sdk/hhyang-uni-simple-router/link */ "js_sdk/hhyang-uni-simple-router/link").then((function () {
    return resolve(__webpack_require__(/*! ./js_sdk/hhyang-uni-simple-router/link.vue */ 893));
  }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
};
...
_vue.default.prototype.$px2rpx = _tools.px2rpx;
_vue.default.prototype.$getImageUri = _tools.getImageUri;
_vue.default.prototype.$copy = _tools.copy;
_vue.default.prototype.$getParent = _tools.getParent;
...
/***/ 27:
/*!***********************************************!*\
  !*** /Users/lisicheng/project/lijian/App.vue ***!
  \***********************************************/
/*! no static exports found */
...
/***/ 28:
/*!************************************************************************!*\
  !*** /Users/lisicheng/project/lijian/App.vue?vue&type=script&lang=js& ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _default = {
      ...
      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _cache.default.set('OPENIMAGE_ENABLE', true);
              console.log(options);
              // 获取公共配置
              _context.next = 4;
              return _this.getConfig().then(function (res) {
  ...
  onShow: function () {
    var _onShow = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(options) {
  ...
  computed: _objectSpread(_objectSpread({}, (0, _vuex.mapGetters)(['site_statistic'])), {}, {
    bindMobile: function bindMobile() {
      // 强制绑定手机号
      return this.appConfig.coerce_mobile;
    }
  }),
  methods: _objectSpread(_objectSpread(_objectSpread({}, (0, _vuex.mapActions)(['getConfig', 'getDecorateConfig', 'getUser', 'getsetserviceConfig', 'getsetshareConfig'])), (0, _vuex.mapMutations)(['logout'])), {}, {
        ...
        return _regenerator.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                invite_code = options.query.invite_code || (0, _tools.strToParams)(decodeURIComponent(options.query.scene)).invite_code;
                console.log(options);
                if (invite_code) {
                  (0, _user.apiDistributionCode)({
                    ...
                    _cache.default.set(_cachekey.INVITE_CODE, invite_code);
                  });
                }
              case 5:
              case "end":
...
/***/ 59:
/*!*********************************************************************************!*\
  !*** /Users/lisicheng/project/lijian/App.vue?vue&type=style&index=0&lang=scss& ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
